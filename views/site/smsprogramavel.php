...
<head>
  ...
  <title>SmS Programável - Telecall</title>
</head>
...
<body>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="menuDropDown dropdown-menu">
            ...
            <li><a href="google.php" class="dropdown-item" href="#">Google
                Verified Calls</a></li>
            <li><a href="smsprogramavel.php" class="dropdown-item" href="#">SMS
                Programável</a></li>
          </ul>
        </li>
      </ul>
  ...
  <main>
    ...
    <section class="oqueecpaas">
      <img src="../../imgs/sms/Interaction Design-pana.png" alt="">
      <div>
        <h1>O que é <span>Sms Programável?</span></h1>
        <p>É muito provável que você já tenha recebido uma mensagem de texto de uma empresa ou organização. Com uma API,
          qualquer empresa pode enviar mensagens de texto e impactar clientes, prospects ou fornecedores como parte de
          seu processo comercial. Com essa ferramenta você envia mensagens de SMS com as informações que o seu cliente
          precisa e com a segurança, a velocidade e a confiabilidade que você espera.</p>
      </div>
    </section>
    ...
    <section class="oqueecpaasContinuação">
      <div>
        <p>Benefícios
          • Comunicação rápida, efetiva e escalável. • Alta taxa de entrega e leitura. • Personalização de data, hora e
          conteúdo. • Baixo custo. • Interação bidirecional: recebimento de respostas. • Agendamento de campanhas. •
          Acompanhamento de métricas e relatórios. • Plataforma user-friendly.</p>
      </div>
    </section>
